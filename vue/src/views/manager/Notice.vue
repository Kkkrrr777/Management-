<template>
  <div>
    <div class="search">
      <el-input placeholder="Please enter the title to search" style="width: 200px" v-model="title"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="id" label="Number" width="80" align="center" sortable></el-table-column>
    ...
    <el-dialog title="Information" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="fromVisible = false">Delete</el-button>
