<template>
  <div>
    <div class="search">
      <el-input placeholder="Please enter the account number for inquiry" style="width: 200px" v-model="username"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="id" label="Number" width="70" align="center" sortable></el-table-column>
        <el-table-column prop="username" label="Account"></el-table-column>
        <el-table-column prop="name" label="Name"></el-table-column>
        <el-table-column prop="phone" label="PhoneNumber"></el-table-column>
        <el-table-column prop="email" label="EmailAddress"></el-table-column>
        <el-table-column label="ProfilePicture">
    ...
    <el-dialog title="Admin" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="EmailAddress" prop="EmailAddress">
          <el-input v-model="form.email" placeholder="EmailAddress"></el-input>
        </el-form-item>
        <el-form-item label="ProfilePicture">
          <el-upload
          ...
          >
            <el-button type="primary">Please Upload Your Profile Picture</el-button>
          </el-upload>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    delBatch() {   // 批量删除
      ...
      this.$confirm('Confirm the bulk deletion of this data？', 'Confirm', {type: "warning"}).then(response => {
